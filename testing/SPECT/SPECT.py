...
data_dir = "/home/richard/School/research/SPECT_Heart_Data_Set/SPECT.train"
...
sum((A@w >= -b).flatten() == y)/len(y)

#creating file
arr = model.coef_[0]
file1 = open("/home/richard/School/research/nnf2sdd2/examples/SPECT.neuron","w")
